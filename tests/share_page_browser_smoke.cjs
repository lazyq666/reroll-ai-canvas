...
const canvasFixture = {
  ...
  nodes: [
    ...
    { id: 'group-media', type: 'smart-group', title: 'Media group', x: 1160, y: 320, w: 320, h: 220, images: [{ url: '/api/shares/visual-token/media/hero?name=group-cover.svg', name: 'group-cover.svg' }] },
  ...
  connections: [{ from: 'image-1', to: 'text-1' }, { from: 'prompt-1', to: 'image-1' }, { from: 'prompt-1', to: 'prompt-generation-1' }],
};
  ...
  try {
    ...
    report = {
      checks: {
        ...
        sharedNodeFamily: desktop.nodeFamily.hosts === desktop.nodeCount && desktop.nodeFamily.customStructureCards === 0 && desktop.nodeFamily.smartGroups === 2 && desktop.nodeFamily.smartGroupMedia === 1 && desktop.nodeFamily.splitters === 1 && desktop.nodeFamily.loops === 1 && desktop.nodeFamily.generationTargets === 1 && desktop.nodeFamily.uploadSurfaces === 1,
        ...
        visibleConnections: desktop.links.count === 3 && desktop.links.pathLength > 0 && desktop.links.layerWidth > 0 && desktop.links.layerHeight > 0 && desktop.links.midpointTopmost && desktop.links.strokeWidth === 2,
