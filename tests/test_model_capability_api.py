...
class ModelCapabilityApiTests(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_model_fetch_attaches_review_summary_and_hides_private_snapshot(self):
        ...
        manager.collect_model_discovery.assert_awaited_once()
        self.assertEqual(
            ["gemini-2.5-pro"],
            manager.collect_model_discovery.call_args.kwargs["chat_model_ids"],
        )
    ...
    def test_admin_matrix_payload_keeps_video_choices(self):
