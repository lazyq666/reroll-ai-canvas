...
const openAiAuto = icons.markup('gpt-image-2');
...
assert.match(openAiAuto, /<img src="\/static\/images\/providers\/chatgpt\.svg\?v=asset-[0-9a-f]{12}"/);
assert.doesNotMatch(openAiAuto, /<feMorphology/);
assert.match(openAiFilled, /data-icon-style="filled"/);
assert.match(openAiFilled, /<img src="\/static\/images\/providers\/chatgpt\.svg\?v=asset-[0-9a-f]{12}"/);
assert.match(openAiOutline, /data-icon-style="outline"/);
assert.match(openAiOutline, /<feMorphology/);
assert.match(openAiOutline, /<image href="\/static\/images\/providers\/chatgpt\.svg\?v=asset-[0-9a-f]{12}"/);
