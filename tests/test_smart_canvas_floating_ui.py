...
class SmartCanvasFloatingUiTests(unittest.TestCase):
    ...
    def test_compact_model_popovers_show_vendor_icons(self):
        ...
        self.assertIn("/static/images/chatgpt.svg", self.script)
        self.assertIn("/static/images/gemini.svg", self.script)
        self.assertIn("/static/images/midjourney.svg", self.script)
        self.assertIn("if (/mid[-_ ]?journey/.test(value)) return 'midjourney';", self.script)
        self.assertIn("/static/images/modelscope.gif", self.script)
