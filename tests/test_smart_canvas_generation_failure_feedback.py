...
class SmartCanvasGenerationFailureFeedbackTests(unittest.TestCase):
    ...
    def test_smart_canvas_uses_ic_alert_with_optional_secondary_small_button(self):
        ...
        self.assertIn("actionLabelFactory:() => options.actionLabel ?? tr('smart.viewDetails')", app)
        self.assertIn("alert.setAttribute('action-label', state.actionLabelFactory())", app)
