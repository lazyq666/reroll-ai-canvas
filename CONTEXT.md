...
在 Smart Canvas 上以一个 Node 拥有 Layer Decomposition Manifest、底图与透明图层，并把它们呈现为单一合成预览的结果节点；它不是成员容器，不能称为 Smart Group。
_Avoid_: Smart Group, Image Group, Layer Group
