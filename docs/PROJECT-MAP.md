...
└── infinite_canvas/
    ...
    ├── model_capability_matrix.py 按稳定 Model ID 聚合现有模型、校验外部研究包、产品选项与跨平台原子应用
    ├── model_capability_refresh.py 外部结构化来源缓存、周期检查、退避与差异草稿
