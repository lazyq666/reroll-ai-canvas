(() => {
  ...
  const SURFACE_MANIFEST_URL = '/static/design-system/infinite-canvas-ui/surface-manifest.json?v=asset-fb35d65c12ec';
  const LEGACY_MANIFEST_URL = '/static/design-system/live-catalog/manifest.json?v=asset-189f0bea70b7';
