(() => {
  ...
  const SURFACE_MANIFEST_URL = '/static/design-system/infinite-canvas-ui/surface-manifest.json?v=asset-56413d2c6666';
  const LEGACY_MANIFEST_URL = '/static/design-system/live-catalog/manifest.json?v=asset-f597a3f6b3af';
