...
function renderReferences() {
  ...
  thumbsRow.innerHTML = referencesVisible ? `
    <div class="input-thumb-list" aria-label="参考素材">
      <ic-reference-thumbnail data-component-name="ic-reference-thumbnail-image" kind="image" label="参考图" src="/static/images/brand/logo.png?v=asset-7bd591a5ba1d" preview-src="/static/images/brand/logo.png?v=asset-7bd591a5ba1d" original-src="/static/images/brand/logo.png?v=asset-7bd591a5ba1d" alt="Reroll 标志参考图" removable remove-label="移除参考图"></ic-reference-thumbnail>
