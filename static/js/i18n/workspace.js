(function(){
    ...
    window.StudioI18n.register({
        ...
        "workspace.loadFailedHint": { zh: "暂时无法读取画布记录，请检查连接后点击刷新。", en: "Canvas records are temporarily unavailable. Check your connection, then refresh." },
        "workspace.noAccessibleProjects": { zh: "暂无可访问项目", en: "No accessible projects" },
        "workspace.noAccessibleProjectsHint": { zh: "管理员尚未为此账号分配项目", en: "No projects are assigned to this account" },
        "workspace.emptyCanvasList": { zh: "画布列表为空", en: "Empty canvas list" },
        "workspace.emptyProjectList": { zh: "项目列表为空", en: "Empty project list" },
        ...
        "workspace.retiredCanvasTitle": { zh: "此画布已停止支持 · Reroll", en: "Canvas no longer supported · Reroll" },
        "workspace.retiredCanvasHeading": { zh: "此画布已停止支持", en: "This canvas is no longer supported" },
        "workspace.retiredCanvasDescription": { zh: "普通画布已退役。原始数据仍会保留，但不能继续打开或编辑。", en: "Classic Canvas has been retired. Its original data is preserved, but it can no longer be opened or edited." },
        "workspace.backToCanvases": { zh: "返回画布列表", en: "Back to canvases" },
