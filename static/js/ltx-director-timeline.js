...
const STYLES = `
  ...
  .pr-wrapper.drag-active {
    outline: var(--ui-border-width-strong) dashed var(--ui-color-border-primary);
  ...
  .pr-btn {
    ...
    border: var(--ui-border-width-thin) solid var(--ui-color-action-primary);
    border-radius: var(--ui-radius-xs);
    ...
    align-items: center;
    gap: var(--ui-space-1);
    transition: all var(--ui-motion-duration-normal) var(--ui-motion-ease-standard);
  }
  .pr-btn:hover {
    background: var(--ui-color-action-primary);
  ...
  .pr-btn-danger:hover {
    background: var(--ui-color-surface-danger);
    border-color: var(--ui-color-border-danger);
  ...
  .pr-prompt-area {
    ...
    box-sizing: border-box;
    outline: none;
    transition: border-color var(--ui-motion-duration-normal) var(--ui-motion-ease-standard);
  }
  ...
  .pr-audio-info span { color: var(--ui-color-text-primary); font-weight: var(--ui-font-weight-medium); }
  .pr-controls-group {
    background: var(--ui-color-action-primary);
    border: var(--ui-border-width-thin) solid var(--ui-color-action-primary);
    border-radius: var(--ui-radius-xs);
  ...
  .pr-height-resizer {
    ...
    cursor: ns-resize;
    border-radius: var(--ui-radius-xs);
    margin: var(--ui-space-0) var(--ui-space-0);
    transition: background var(--ui-motion-duration-fast);
    border: var(--ui-border-width-thin) solid var(--ui-color-border-secondary);
  }
  ...
  .pr-gap-menu-btn {
    ...
    align-items: center;
    gap: var(--ui-space-1);
    transition: background var(--ui-motion-duration-fast) var(--ui-motion-ease-standard);
  }
  ...
  .pr-player-controls {
    ...
    align-items: center;
    gap: var(--ui-space-3);
    padding: var(--ui-space-0) var(--ui-space-0);
    flex-wrap: wrap;
    width: 100%;
  }
  .pr-icon-btn {
    ...
    align-items: center;
    justify-content: center;
    transition: all var(--ui-motion-duration-normal);
  }
  .pr-icon-btn * {
    pointer-events: none;
  }
  ...
  .pr-seek-bar::-webkit-slider-thumb {
    ...
    background: var(--ui-color-surface);
    cursor: pointer;
    border: var(--ui-border-width-strong) solid var(--ui-color-border-secondary);
  }
  ...
  .pr-settings-title {
    ...
    letter-spacing: var(--ui-letter-spacing-wide);
    padding-bottom: var(--ui-space-1);
    border-bottom: var(--ui-border-width-thin) solid var(--ui-color-border-secondary);
    margin-bottom: var(--ui-space-0);
  }
  .pr-settings-row {
    display: flex;
    align-items: center;
  ...
  .pr-settings-divider {
    border: none;
    border-top: var(--ui-border-width-thin) solid var(--ui-color-border-secondary);
    margin: var(--ui-space-0) var(--ui-space-0);
  }
  .pr-settings-toggle-btn {
    ...
    cursor: pointer;
    text-align: center;
    transition: all var(--ui-motion-duration-fast);
  }
  ...
  .pr-segment {
    ...
    border-radius: var(--ui-radius-xs);
    color: var(--ui-color-text-primary);
    transition: all var(--ui-motion-duration-fast) var(--ui-motion-ease-standard);
  }
  .pr-segment.active {
    background: var(--ui-color-action-secondary-selected);
    color: var(--ui-color-text-primary);
...
class TimelineEditor {
  ...
  createDOM() {
    ...
    settingsBtn.style.padding = "var(--ui-space-1)";
    settingsBtn.style.justifyContent = "center";
    settingsBtn.style.width = "28px";
    settingsBtn.style.height = "var(--ui-control-height-s)";
    ...
    toggleBtn.style.padding = "var(--ui-space-1) var(--ui-space-2)";
    toggleBtn.style.fontSize = "var(--ui-font-size-2)";
    ...
    const updateToggleStyle = (isOn) => {
      ...
      if (isOn) {
        toggleBtn.style.background = "var(--ui-color-surface)";
        toggleBtn.style.borderColor = "var(--ui-color-border-secondary)";
        toggleBtn.style.color = "var(--ui-color-text-primary)";
      } else {
        toggleBtn.style.background = "var(--ui-color-surface)";
        toggleBtn.style.borderColor = "var(--ui-color-border-secondary)";
        toggleBtn.style.color = "var(--ui-color-text-primary)";
    ...
    helpBtn.style.padding = "var(--ui-space-1)";
    helpBtn.style.justifyContent = "center";
    helpBtn.style.width = "28px";
    helpBtn.style.height = "var(--ui-control-height-s)";
    ...
    btnGroup.style.gap = "var(--ui-space-1)";
    ...
    this.playBtn.style.padding = "var(--ui-space-1)";
    ...
    this.loopBtn.style.padding = "var(--ui-space-1)";
    ...
    zoomOutBtn.style.padding = "var(--ui-space-1)";
    ...
    zoomInBtn.style.padding = "var(--ui-space-1)";
    ...
    zoomFitBtn.style.padding = "var(--ui-space-1)";
    zoomFitBtn.style.marginLeft = "var(--ui-space-1)";
  ...
  showContextMenu(clientX, clientY, seg, trackType) {
    ...
    if (isImage) {
      ...
      openBtn.onclick = () => {
        ...
        if (win) {
          win.document.write(`<body style="margin:var(--ui-space-0);display:flex;justify-content:center;align-items:center;background:var(--ui-color-surface);height:100vh;"><img style="max-width:100%;max-height:100%;" src="${seg.imageB64}" /></body>`);
          win.document.close();
        }
        this.dismissContextMenu();
      };
    ...
    delBtn.style.color = "var(--ui-color-text-danger)";
    delBtn.onclick = () => {
  ...
  _showCanvasSettingsMenu(anchorEl) {
    ...
    gp.style.minHeight = "var(--ui-control-height-l)";
    ...
    menu.style.zIndex = "var(--ui-z-toast)";
    document.body.appendChild(menu);
